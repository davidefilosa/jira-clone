...
export const Client = () => {
  ...
  const isLoading =
    isLoadingAnalytics || isLoadingMember || isLoadingProject || isLoadingtasks;
    ...
    <div className="flex flex-col gap-y-4 col-span-1">
      <div className="bg-muted rounded-lg p-4">
        <div className="flex items-center justify-between">
          <p className="font-lg text-semibold">Tasks ({total})</p>
          <Button variant={"muted"} size={"icon"} onClick={openTask}>
                ...
                <Card className="shadow-none rounded-lg hover:opacity-75 transition">
                  <CardContent className="p-4">
                    ...
                    <div className="flex items-center gap-x-2">
                      ...
                      <div className="size-1 rounded-ull bg-neutral-300" />
  ...
  return (
    <div className="flex flex-col gap-y-4 col-span-1">
      <div className="bg-white border rounded-lg p-4">
        <div className="flex items-center justify-between">
          <p className="font-lg text-semibold">Projects ({total})</p>
          <Button variant={"secondary"} size={"icon"} onClick={openProject}>
            <Plus className="size-4 text-neutral-400" />
          </Button>
        </div>
        <DottedSeparator className="my-4" />
...
export const MembersList = ({ data, total }: MembersListProps) => {
  ...
  return (
    <div className="flex flex-col gap-y-4 col-span-1">
      <div className="bg-white border rounded-lg p-4">
        <div className="flex items-center justify-between">
          <p className="font-lg text-semibold">Members ({total})</p>
              ...
              <Card className="shadow-none rounded-lg overflow-hidden">
                <CardContent className="p-2 flex flex-col items-center gap-y-2">
                  <MemberAvatar
                    ...
                    fallbackClassName="text-lg"
                  />
                  <div className="flex flex-col items-center overflow-hidden gap-y-2">
